...
class DetilTransaksiLayanan extends RestController{
    ...
    public function index_post($id_detil = null){
        ...
        if($id_detil==null){
			...
			return $this->returnData($this->form_validation->error_array(), true,400);
                ...
                $DetilTransaksiLayanan->jumlah_detil_layanan = $this->post('jumlah_detil_layanan');
    ...
    public function index_put($id_detil){
        $DetilTransaksiLayanan = new dataDetilTransaksiLayanan();
        $DetilTransaksiLayanan->id_layanan = $this->put('id_layanan');
        $DetilTransaksiLayanan->jumlah_detil_layanan = $this->put('jumlah_detil_layanan');
