...
class HewanModel extends CI_Model{
    ...
    public function getall($id){
        if($id==null){
            $this->db->select('HEWAN.ID_HEWAN,JENIS_HEWAN.ID_JENISHEWAN,JENIS_HEWAN.JENISHEWAN,HEWAN.NAMA_HEWAN,
            HEWAN.TGL_LAHIR_HEWAN,PELANGGAN.ID_PELANGGAN,PELANGGAN.NAMA_PELANGGAN,PEGAWAI.NAMA_PEGAWAI,HEWAN.CREATE_AT_HEWAN,HEWAN.UPDATE_AT_HEWAN,HEWAN.DELETE_AT_HEWAN')
                    ->from('HEWAN')
