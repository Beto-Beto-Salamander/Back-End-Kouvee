...
class LayananModel extends CI_Model{
    ...
    public function getall($id){
        if($id==null){
            $this->db->select('LAYANAN.ID_LAYANAN,UKURAN.ID_UKURAN,UKURAN.UKURAN,JENIS_HEWAN.ID_JENISHEWAN,JENIS_HEWAN.JENISHEWAN,LAYANAN.NAMA_LAYANAN,LAYANAN.HARGA_LAYANAN,PEGAWAI.NAMA_PEGAWAI,LAYANAN.CREATE_AT_LAYANAN,LAYANAN.UPDATE_AT_LAYANAN,LAYANAN.DELETE_AT_LAYANAN,JENIS_HEWAN.ID_JENISHEWAN,LAYANAN.ID_UKURAN')
                    ->from('LAYANAN')
            ...
            $this->db->select('LAYANAN.ID_LAYANAN,UKURAN.ID_UKURAN,UKURAN.UKURAN,JENIS_HEWAN.ID_JENISHEWAN,JENIS_HEWAN.JENISHEWAN,LAYANAN.NAMA_LAYANAN,LAYANAN.HARGA_LAYANAN,PEGAWAI.NAMA_PEGAWAI,LAYANAN.CREATE_AT_LAYANAN,LAYANAN.UPDATE_AT_LAYANAN,LAYANAN.DELETE_AT_LAYANAN')
                    ->from('LAYANAN')
                    ->join('UKURAN','LAYANAN.ID_UKURAN = UKURAN.ID_UKURAN')
                    ->join('JENIS_HEWAN','LAYANAN.ID_JENISHEWAN = JENIS_HEWAN.ID_JENISHEWAN')
                    ->join('PEGAWAI','LAYANAN.ID_PEGAWAI = PEGAWAI.ID_PEGAWAI')
