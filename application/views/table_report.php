...
<div class="center">
	...
	<?php foreach($layanan as $list): ?>
		<div style='display:flex;'>
		<div class='column' style='text-align:right'>
		<?php $subt = "Rp " . number_format($list->SUBTOTAL_TRANSAKSI_LAYANAN,2,',','.');?>
		<?php $disc = "Rp " . number_format($list->DISKON_LAYANAN,2,',','.');?>
		<?php $total = "Rp " . number_format($list->TOTAL_TRANSAKSI_LAYANAN,2,',','.');?>
